...
class Worker(QtCore.QObject):
    ...
    startTest = QtCore.pyqtSignal(str, str)
    endTest = QtCore.pyqtSignal(str, str, int)
    postThread = QtCore.pyqtSignal()
    abordTest = QtCore.pyqtSignal()

    def __init__(self, option, count, stateBox):
...
class Window(QtWidgets.QMainWindow):
    ...
    #Handling QThread signals
    def start_test(self, nameSuite, nameTest):
        self.text.setText("Actual Suite Test : "+ nameSuite+",   actual test : " + nameTest)
        self.colorActuelTest(nameTest, "actuel")
    
    def end_test(self, status, name, count):
        self.updateProgress(self.pbar.value() + count)
